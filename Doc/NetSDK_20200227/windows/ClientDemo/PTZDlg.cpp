...
void CPTZDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BTN_SETLEFT, m_myBtnSetLeft);
	DDX_Control(pDX, IDC_BTN_SETRIGHT, m_myBtnSetRight);
	DDX_Control(pDX, IDC_BTN_SETAUTO, m_myBtnSetAuto);
	DDX_Control(pDX, IDC_BTN_SETSTOP, m_myBtnSetStop);
}
...
BOOL CPTZDlg::OnInitDialog()
{
	...
	m_myBtnSetLeft.SubclassDlgItem(IDC_BTN_SETLEFT,this);
	m_myBtnSetLeft.SetType(1000);
	m_myBtnSetRight.SubclassDlgItem(IDC_BTN_SETRIGHT,this);
	m_myBtnSetRight.SetType(1000);
	m_myBtnSetAuto.SubclassDlgItem(IDC_BTN_SETAUTO,this);
	m_myBtnSetAuto.SetType(1000);
	m_myBtnSetStop.SubclassDlgItem(IDC_BTN_SETSTOP,this);
	m_myBtnSetStop.SetType(1000);
