...
protected:
	...
	CColorButton m_myBtnSetLeft;
	CColorButton m_myBtnSetRight;
	CColorButton m_myBtnSetAuto;
	CColorButton m_myBtnSetStop;
...
public:
	...
	afx_msg void OnBnClickedBtnSetleft();
	afx_msg void OnBnClickedBtnSetright();
	afx_msg void OnBnClickedBtnSetauto();
	afx_msg void OnBnClickedBtnSetstop();
	afx_msg void OnBnClickedCruisestop();
};
