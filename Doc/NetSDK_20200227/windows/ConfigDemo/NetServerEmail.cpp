...
void CNetServerEmail::InitDlgInfo(SDK_NetEmailConfig *pNetEmailCfg,long LoginID)
{
	...
	m_ctlEnableSSL.SetCheck(m_netEmailCfg.cEncryptType);
...
void CNetServerEmail::OnCheckSslEnable() 
{
	...
	if (true == enableSSL)
		m_netEmailCfg.cEncryptType = true;
	else
		m_netEmailCfg.cEncryptType = false;
}
...
void CNetServerEmail::SaveConfig()
{
	...
	m_netEmailCfg.cEncryptType = m_ctlEnableSSL.GetCheck();
