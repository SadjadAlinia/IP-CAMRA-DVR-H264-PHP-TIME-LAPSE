...
public:
	...
	void InitDlgInfo(SDK_VIDEOLOSSCONFIG *StorageNE,SDK_StorageFailConfig *StorageFL,SDK_VIDEOLOSSCONFIG *NetipCfg,SDK_VIDEOLOSSCONFIG *NetaBort,SDK_SystemFunction *SysFunc,SDK_StorageLowSpaceConfig *StorageLSCfg);
...
private:
	...
	SDK_StorageFailConfig m_StorageFL;
