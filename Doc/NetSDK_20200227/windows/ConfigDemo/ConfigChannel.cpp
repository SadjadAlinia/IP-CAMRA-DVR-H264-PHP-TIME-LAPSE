...
//大小眼睛的低码率
static int LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_EXT_V3_NR][6] = {
...
static int FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_EXT_V3_NR][6] = {
...
static int H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_EXT_V3_NR][6] = {
...
BEGIN_MESSAGE_MAP(CConfigChannel, CDialog)
	...
	ON_CBN_SELCHANGE(IDC_COMBO_CODE_FORMAT, OnSelchangeComboResolution)
	ON_CBN_SELCHANGE(IDC_COMBO_EXPAND, OnSelchangeComboResolution)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
								 ...
								 SDK_EncodeStaticParamAll *pEncodeStatic)
{
	...
	m_bLowBitrate = pSysFunc->vEncodeFunction[SDK_ENCODE_FUNCTION_TYPE_LOW_BITRATE];
	m_bFisheyeBitrate = pSysFunc->vOtherFunction[SDK_OTHER_SUPPORT_FISH_EYE];

	//主码流的赋值
	SDK_MEDIA_FORMAT& dstMainFmt = pEncodeSimpl->vEncodeConfigAll[ChannnelNum - 1].dstMainFmt;
	SDK_VIDEO_FORMAT& vfFormat = dstMainFmt.vfFormat;

	if (SDK_CAPTURE_COMP_H265 == vfFormat.iCompression)
	{
		m_bH265Bitrate[MAIN_STREAM] = true;
	}
	else
	{
		m_bH265Bitrate[MAIN_STREAM] = false;
	...
	//辅码流的赋值
	SDK_MEDIA_FORMAT &dstExtraFmt = pEncodeSimpl->vEncodeConfigAll[ChannnelNum - 1].dstExtraFmt;
	SDK_VIDEO_FORMAT &vfExFormat = dstExtraFmt.vfFormat;

	if (SDK_CAPTURE_COMP_H265 == vfExFormat.iCompression)
	{
	...
	StructToWin(vfFormat.iCompression, vfExFormat.iCompression);
}
...
// 		m_resolution[SDK_CAPTURE_SIZE_5M].strText = "5M(3744*1408)";
		...
		m_resolution[SDK_CAPTURE_SIZE_5M].strText = "5M(3744*1408)";
		m_resolution[SDK_CAPTURE_SIZE_1080N].strText = "1080N(944*1080)"; 
		m_resolution[SDK_CAPTURE_SIZE_4M].strText = "4M(2592*1520)"; 
		m_resolution[SDK_CAPTURE_SIZE_6M].strText = "6M(3072*2048)"; 
		m_resolution[SDK_CAPTURE_SIZE_8M].strText = "8M(3264*2448)"; 
		m_resolution[SDK_CAPTURE_SIZE_12M].strText = "12M(4000*3000)"; 
		m_resolution[SDK_CAPTURE_SIZE_4K].strText = "4K(4096*2160)"; 
		m_resolution[SDK_CAPTURE_SIZE_720N].strText = "720N(640*720)"; 
		m_resolution[SDK_CAPTURE_SIZE_WSVGA].strText = "WSVGA(1024*576)"; 
		m_resolution[SDK_CAPTURE_SIZE_NHD].strText = "NHD(640*360)"; 
		m_resolution[SDK_CAPTURE_SIZE_3M_N].strText = "3M_N(1024*1536)"; 
		m_resolution[SDK_CAPTURE_SIZE_4M_N].strText = "4M_N(1296*1520)"; 
		m_resolution[SDK_CAPTURE_SIZE_5M_N].strText = "5M_N(1872*1408)"; 
		m_resolution[SDK_CAPTURE_SIZE_4K_N].strText = "4K_N(2048*2160)";  ///2048 * 2160通用/1920*2160海思
		...
		m_resolution[SDK_CAPTURE_SIZE_1080N].dwSize = 944*1080; 
		...
		m_resolution[SDK_CAPTURE_SIZE_720N].dwSize = 640*720; 
		m_resolution[SDK_CAPTURE_SIZE_WSVGA].dwSize = 1024*576; 
		m_resolution[SDK_CAPTURE_SIZE_NHD].dwSize = 640*360; 
		m_resolution[SDK_CAPTURE_SIZE_3M_N].dwSize = 1024*1536; 
		m_resolution[SDK_CAPTURE_SIZE_4M_N].dwSize = 1296*1520; 
		m_resolution[SDK_CAPTURE_SIZE_5M_N].dwSize = 1872*1408; 
		m_resolution[SDK_CAPTURE_SIZE_4K_N].dwSize = 2048*2160;  ///2048 * 2160通用/1920*2160海思
	}		
	else
	{
...
// 		m_resolution[SDK_CAPTURE_SIZE_5M].strText = "5M(3744*1408)";
	...
	m_resolution[SDK_CAPTURE_SIZE_1080N].dsMask  = BITMSK(SDK_CAPTURE_SIZE_650TVL) | BITMSK(SDK_CAPTURE_SIZE_D1) | BITMSK(SDK_CAPTURE_SIZE_CIF) | BITMSK(SDK_CAPTURE_SIZE_QCIF) | BITMSK(SDK_CAPTURE_SIZE_720P);
	m_resolution[SDK_CAPTURE_SIZE_4M].dsMask  = BITMSK(SDK_CAPTURE_SIZE_D1) | BITMSK(SDK_CAPTURE_SIZE_HD1) | BITMSK(SDK_CAPTURE_SIZE_CIF) | BITMSK(SDK_CAPTURE_SIZE_QCIF) | BITMSK(SDK_CAPTURE_SIZE_720P);
	m_resolution[SDK_CAPTURE_SIZE_720N].dsMask  = BITMSK(SDK_CAPTURE_SIZE_CIF) | BITMSK(SDK_CAPTURE_SIZE_QCIF);
	
	if(m_bLowBitrate)
	{
		m_maxBitRate[SDK_CAPTURE_SIZE_D1] =  LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_D1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_HD1] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_HD1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_BCIF] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_BCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_CIF] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_CIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QCIF] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_VGA] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_VGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QVGA] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_SVCD] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_SVCD][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QQVGA] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QQVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_ND1] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_ND1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_650TVL] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_650TVL][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_720P] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_720P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1_3M] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_UXGA] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_UXGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1080P] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1080P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_WUXGA] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_WUXGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_2_5M] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_2_5M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_3M] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_5M] = LOWBITRATE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_5M][5];

	}else if (m_bFisheyeBitrate)
	{
		m_maxBitRate[SDK_CAPTURE_SIZE_D1] =  FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_D1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_HD1] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_HD1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_BCIF] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_BCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_CIF] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_CIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QCIF] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_VGA] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_VGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QVGA] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_SVCD] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_SVCD][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QQVGA] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QQVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_ND1] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_ND1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_650TVL] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_650TVL][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_720P] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_720P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1_3M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_UXGA] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_UXGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1080P] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1080P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_WUXGA] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_WUXGA][5];
		//m_maxBitRate[SDK_CAPTURE_SIZE_0_33M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_0_33M][5];
		//	m_maxBitRate[SDK_CAPTURE_SIZE_2_35M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_2_35M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_2_5M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_2_5M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_3M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_5M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_5M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_6M] = FISHEYE_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_6M][5];

	}else if (m_bH265Bitrate[MAIN_STREAM] || m_bH265Bitrate[EXPAND_STREAM])
	{
		m_maxBitRate[SDK_CAPTURE_SIZE_D1] =  H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_D1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_HD1] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_HD1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_BCIF] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_BCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_CIF] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_CIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QCIF] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QCIF][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_VGA] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_VGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QVGA] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_SVCD] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_SVCD][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_QQVGA] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_QQVGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_ND1] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_ND1][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_650TVL] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_650TVL][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_720P] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_720P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1_3M] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_UXGA] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_UXGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_1080P] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1080P][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_WUXGA] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_WUXGA][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_2_5M] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_2_5M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_3M] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_3M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_5M] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_5M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_6M] = H265_STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_6M][5];
	}else
	{
		...
		m_maxBitRate[SDK_CAPTURE_SIZE_1080N] = STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_1080N][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_4M] = STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_4M][5];
		m_maxBitRate[SDK_CAPTURE_SIZE_720N] = STREAM_CODE_VALUE[SDK_CAPTURE_SIZE_720N][5];
	}
...
bool CConfigChannel::AllStructToWinData(int nChannelNum, SDK_CONFIG_ENCODE_SIMPLIIFY *pConfigEncode, int nEncodeType)
{
	if (nEncodeType == MAIN_STREAM || (nEncodeType == EXPAND_STREAM && m_bMultiStream))
	{
		...
		dwPower = lFreePower / nChannelCount;
...
bool CConfigChannel::StructToWinData(int nChannelNum, SDK_CONFIG_ENCODE_SIMPLIIFY *pConfigEncode, int nEncodeType, DWORD dwPower, DWORD dwMask, DWORD dwBitrate)
{
	...
	if(m_bLowBitrate)
	{
		for (j = 0; j < sizeof(LOWBITRATE_STREAM_CODE_VALUE[vfSetFormat.iResolution]) / sizeof(int); ++j)
		{
			...
			int iBitrate = LOWBITRATE_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
			_stprintf(sBitrate, "%d", LOWBITRATE_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1));
	...
	else if(m_bFisheyeBitrate)
	{
		for (j = 0; j < sizeof(FISHEYE_STREAM_CODE_VALUE[vfSetFormat.iResolution]) / sizeof(int); ++j)
		{
			...
			int iBitrate = FISHEYE_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
			_stprintf(sBitrate, "%d", FISHEYE_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1));
	...
	else if(m_bH265Bitrate[nEncodeType])
	{
		for (j = 0; j < sizeof(H265_STREAM_CODE_VALUE[vfSetFormat.iResolution]) / sizeof(int); ++j)
		{
			TCHAR sBitrate[8];

			int iBitrate = H265_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
			_stprintf(sBitrate, "%d", H265_STREAM_CODE_VALUE[vfSetFormat.iResolution][j] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1));
	...
	else
	{
		if (m_bLowBitrate)
		{		
			DWORD dwCntBitrate = LOWBITRATE_STREAM_CODE_VALUE[vfSetFormat.iResolution][vfSetFormat.iQuality - 1] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
		...
		{
			DWORD dwCntBitrate = FISHEYE_STREAM_CODE_VALUE[vfSetFormat.iResolution][vfSetFormat.iQuality - 1] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
			dwBitrate = (dwBitrate > dwCntBitrate) ? dwCntBitrate : dwBitrate;
			bool nret = SetComBoxCurSel(ControlID[nEncodeType][CONTROL_BIT_RATE],  NearBitrate(ControlID[nEncodeType][CONTROL_BIT_RATE], dwBitrate));
		}
		else if (m_bH265Bitrate[nEncodeType])
		{
			DWORD dwCntBitrate = H265_STREAM_CODE_VALUE[vfSetFormat.iResolution][vfSetFormat.iQuality - 1] * (vfSetFormat.iGOP * nTmpFPS +  IFRAME_EQ_PFRAME - 1) / (vfSetFormat.iGOP * nFPS + IFRAME_EQ_PFRAME - 1);
			dwBitrate = (dwBitrate > dwCntBitrate) ? dwCntBitrate : dwBitrate;
			bool nret = SetComBoxCurSel(ControlID[nEncodeType][CONTROL_BIT_RATE],  NearBitrate(ControlID[nEncodeType][CONTROL_BIT_RATE], dwBitrate));
		}
		else
...
bool CConfigChannel::StructToWin(int MainType, int ExpandType)
{
	bool bRet = false;
	...
	int nCount = ((CComboBox *)GetDlgItem(IDC_COMBO_CODE_FORMAT))->GetCount();

	for (int i = 0;i < nCount;i++)
	{
		((CComboBox *)GetDlgItem(IDC_COMBO_CODE_FORMAT))->SetCurSel(i);
		CString strTemp;
		((CComboBox *)GetDlgItem(IDC_COMBO_CODE_FORMAT))->GetWindowText(strTemp);
		if (strTemp == m_mapCaptureComp[MainType])
		{
			break;
		}
	}

	int nIndex = ((CComboBox *)GetDlgItem(IDC_COMBO_EXPAND))->GetCount();

	for (int i = 0;i < nIndex;i++)
	{
		((CComboBox *)GetDlgItem(IDC_COMBO_EXPAND))->SetCurSel(i);
		CString strTemp;
		((CComboBox *)GetDlgItem(IDC_COMBO_EXPAND))->GetWindowText(strTemp);
		if (strTemp == m_mapCaptureComp[ExpandType])
		{
			break;
		}
	}
...
void CConfigChannel::OnSelchangeComboResolution() 
{
	...
	else
	{
		...
		CString strTemp;
		((CComboBox *)GetDlgItem(IDC_COMBO_CODE_FORMAT))->GetWindowText(strTemp);
		if (strTemp != m_mapCaptureComp[SDK_CAPTURE_COMP_H265])
		{
			m_bH265Bitrate[MAIN_STREAM] = false;
		}
		else
		...
		CString strTemp1;
		((CComboBox *)GetDlgItem(IDC_COMBO_EXPAND))->GetWindowText(strTemp1);
		if (strTemp1 != m_mapCaptureComp[SDK_CAPTURE_COMP_H265])
		{
			m_bH265Bitrate[EXPAND_STREAM] = false;
		}
		else
