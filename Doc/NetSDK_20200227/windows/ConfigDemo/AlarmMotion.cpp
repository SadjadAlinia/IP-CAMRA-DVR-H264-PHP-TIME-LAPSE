...
BOOL CAlarmMotion::SaveMotionInfo()
{
	...
	if (nIndex == m_nChannelNum)
	{
		...
		{
			SDK_EventHandler &eventHander = m_MotionCfgAll.vMotionDetectAll[i].hEvent;
	...
	{
		SDK_EventHandler &eventHander = m_MotionCfgAll.vMotionDetectAll[m_nLastChannel].hEvent;
