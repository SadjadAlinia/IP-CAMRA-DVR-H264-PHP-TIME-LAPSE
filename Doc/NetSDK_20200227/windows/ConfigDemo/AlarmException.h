...
public:
	BOOL InitWndShow();
	void InitDlgInfo(SDK_VIDEOLOSSCONFIG *pStorageNE,SDK_StorageFailConfig *pStorageFL,SDK_VIDEOLOSSCONFIG *pNetipCfg,SDK_VIDEOLOSSCONFIG *pNetaBort,SDK_SystemFunction *pSysFunc,SDK_StorageLowSpaceConfig *pStorageLSCfg);
	BOOL SaveAlarmExceptionInfo();
	void ShowInfo();
	void CleanAll();
	SDK_VIDEOLOSSCONFIG m_OldExceptionNoExist;
	SDK_StorageFailConfig m_OldExceptionFailed;
