...
private:
	...
	bool StructToWin(int MainType, int ExpandType);
...
public:
	...
	int m_maxBitRate[SDK_CAPTURE_SIZE_EXT_V3_NR];
	SResolution m_resolution[SDK_CAPTURE_SIZE_EXT_V3_NR];
