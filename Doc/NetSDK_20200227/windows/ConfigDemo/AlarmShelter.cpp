...
BOOL CAlarmShelter::SaveShelterInfo()
{
	...
	if (nIndex == m_nChannelNum)
	{
		...
		{
			SDK_EventHandler &eventHander = m_ShelterCfgAll.vBlindDetectAll[i].hEvent;
	...
	{
		SDK_EventHandler &eventHander = m_ShelterCfgAll.vBlindDetectAll[m_nLastChannel].hEvent;
