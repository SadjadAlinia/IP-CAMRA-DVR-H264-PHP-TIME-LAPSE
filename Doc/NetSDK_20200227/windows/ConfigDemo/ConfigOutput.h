...
public:
	...
	SDK_VGAresolution m_OutVGAresolution;
	int m_nbyChanNum;
	void InitDlgInfo(OUTPUTCONFIGALL* pOutputCfgAll,SDK_VGAresolution* VGAresolution, int nbyChanNum);
...
private:
	...
	void InitVGAResAbiInfo();
public:
	afx_msg void OnCbnSelchangeComboVideoresolution();
	CComboBox m_VideoResolution;
};
